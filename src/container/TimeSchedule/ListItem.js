...
function ListItem(props) {
  return (
    <div className="p-5 lg:p-6 bg-white cursor-pointer rounded-lg flex flex-row justify-center items-center group shadow-list-section transition duration-400 ease-in-out transform hover:-translate-x-2 hover:bg-card-red hover:text-white">
