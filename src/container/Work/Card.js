...
function Card(props) {
  return (
    <div className="px-8 py-12 md:self-stretch cursor-pointer rounded-xl flex flex-col gap-y-5 justify-center items-center group shadow-card-initial transition duration-400 ease-in-out hover:shadow-card-final transform hover:-translate-y-2 hover:bg-card-red hover:text-white">
