    ...
    <>
      <div className="max-w-screen-lg mx-auto px-10 my-16 text-gray-600  text-md flex flex-col gap-y-4">
        ...
        <p>
          ...
          website, the associated mobile app and our widget that is implemented
          on third-party platforms (hereinafter "
          <span className="font-medium">platform</span>" refers to both the
        ...
        <p>
          ...
          also include data which you have voluntarily provided to us or which
          we receive from our partners.
          <div className="highlight my-2.5">
            <span className=" font-bold text-red-500"></span>
            Data that we collect automatically when you use our platform
          </div>
          As soon as you visit the website or open the app, you send technical
          information to our web servers. This happens regardless of whether you
          make a reservation at a restaurant or whether you log in later using
          an account with us to use the platform. In each case we collect the
          following access data and web access data (which we refer to
          collectively as "<span className="highlight">access data</span>" ):4
          <ul className="highlight flex flex-col gap-y-1 mt-2.5">
            <li>
              * the date and time of the visit and the duration of the use of
              the platform
            </li>
            <li>* the IP address of your device</li>
            <li>
              * the reference URL (the website from which you may have been
              redirected)
            </li>
            <li>
              * the visited subpages of the website or subsections of the app;
              and{" "}
            </li>
            <li>
              * further information about your device (device type, browser type
              and version, settings, installed plug-ins, operating system)
            </li>
            <li></li>
          </ul>
        </p>
        ...
        <p>
          ...
          work, which cookies we use, and how to disable them, read our cookie
          policy. It also tells you what information is collected by cookies and
          ...
          <ul className="highlight flex flex-col gap-y-1 my-2 pl-4">
            <li>* Name and surname </li>
            <li>* E-mail address </li>
            <li>* the restaurant where you make your reservation</li>
            <li>* Telephone number </li>
            <li>* the number of guests</li>
            <li>* time of reservation</li>
            <li>* special preferences</li>
          </ul>
          Please do not enter any sensitive personal information in the field "
          <span className="highlight">special preferences</span>". We process
          ...
          these features, your IP address will be stored when you post a comment
          or rating. This is a protective measure for us in case someone
          publishes illegal content, comments and/or contributions (insults,
          forbidden political propaganda, etc.). In such cases, we must be able
          to determine the identity of the author, as legal action can be taken
          based on the content in the comments or posts.
          <br />
          If you would like to subscribe to the following comments, a
          confirmation email will be sent to confirm that you are actually the
          ...
          way that only the payment provider can access, while we only receive
          ...
          in the confirmation email. This way we can make sure that you are the
          rightful owner of the email address. The newsletter contains
          information about Capitol Tech, restaurants and current offers. Legal
          basis for the sending of newsletters is your consent.
          <br />
          When subscribing to the newsletter, we collect your IP address, the
          date and the exact time of your subscription. This data is stored in
          order to prove that you signed up to the newsletter. Also, we need the
          data in case your email address was fraudulently used
          <br />
          Furthermore, when interacting with the newsletter, we collect device
          and usage data. For example, we record if the newsletter was
          delivered, if you opened the newsletter or if you clicked on a link in
          the newsletter. We link your email address to this data in order to
          personalise and statistically analyse the newsletter. If you use our
          app, we will also connect the data collected within the app with this
          usage data from the newsletter. This way we make sure that we display
          offers within the app that are relevant to you.
          <br />
          You can withdraw your consent to receive newsletters with any form of
          personalisation at any time without incurring any costs other than the
          ...
          information from third party platforms where a reservation made by you
          on that third party platform is made by Capitol Tech. The data in
          question comprises:
          <ul className="highlight flex flex-col gap-y-1 my-2 pl-4">
          ...
          profiles using pseudonyms. Cookies are set for this purpose. Based on
          these cookies, we can carry out statistical evaluations, for instance.
          This serves our legitimate interest on an optimised presentation (for
        ...
        <p>
          ...
          <ul className="highlight flex flex-col gap-y-1 my-2">
            <li>
              * passing on your personal data to third parties if we are legally
              obliged to do so;
            </li>
            <li>* assertion of legal claims and defence in legal disputes;</li>
            <li>
              * compliance with legal requirements for data retention due to tax
              legislation, etc.
            </li>
          </ul>
        </p>
        ...
        <p>
          ...
          making a reservation, you expressly consent to the processing of your
          data as described in this Privacy Policy by crossing the box before
          submitting the registration or reservation form: When we process your
          ...
          your consent, but also because it is necessary to fulfil our contract
          ...
          purposes described above, for which we process your data, in many
          cases also represent legitimate interests. This means that we may
          process the data necessary to ensure the security of our IT systems in
          any case, even if you have not given or withdrawn your consent to such
        ...
        <p>
          ...
          legal obligation to do so as a result of a request for information
          from the competent authority.
          <br />
          Beyond statutory obligations to public authorities, we will only share
          ...
          ensure the smooth running of these programs. Restaurants will receive
          your account information (except your password) and any ratings or
          reviews you enter into the platform's system. Ratings and reviews will
          ...
          of our server hosting and cloud services are made available by Amazon
          Web Services, Inc. (" AWS") as well as Google Ireland Limited. Both
        ...
        <p>
          ...
          you exists and after termination only to the extent that and as long
          as the applicable laws require. All other data will be deleted
          immediately when you log out of the platform. If the remaining data is
          no longer required for fulfilment of such obligations, then the data
        ...
        <p>
          ...
          create customised offers based on your previous behaviour patterns.
          For example, the IP address of your computer is used to identify your
          geographic location and provide you with localised content in your
          language. We can make suggestions and offers for new restaurants based
          on the restaurants you have previously viewed or booked through our
          platform. However, we will never process and analyse your personal
        ...
        <p>
          ...
          and conditions means that you are under no obligation to provide your
          personal data. However, the transmission of the contract information
          you send to us is a basic prerequisite for the conclusion of a
        ...
        <p>
          ...
          tracking tools provided on our platform either by us or by third
          parties.
          <br />
          We use the following types of cookies only within the scope of legal
          regulations and on the basis of the legal founda-tions specified:
          <ul className=" flex flex-col gap-y-1 my-2">
            <li>
              <span className="highlight pl-3">Necessary cookies:</span>{" "}
              Necessary cookies enable the basic functions on a homepage, such
              as its navigation or access to protected areas. Our homepage does
              not function without cookies, or only in a limited manner.
            </li>
            <li>
              <span className="highlight pl-3">Preference cookies:</span>{" "}
              Preference cookies help us to improve functionality and
              personalisation. For example, settings can be stored regarding the
              preferred language. The cookies are used by us or by third parties
              inte-grated by us.
            </li>
            <li>
              <span className="highlight pl-3">Statistics cookies:</span>{" "}
              Statistics cookies help us to understand how our users interact
              with the website. For example, this means that we can analyse how
              users access our website and how they use it.
            </li>
            <li>
              <span className="highlight pl-3">Marketing cookies:</span>{" "}
              Marketing cookies help us to track users via various channels and
              address them in a targeted manner. The aim is to only display
              interesting and relevant promotional content for users.
            </li>
          </ul>
          You can prevent the acceptance of cookies by adjusting your browser
          settings so that no cookies are ac-cepted at all. However, if you
          configure this setting in this way, you may not be able to use certain
          current or future elements of our website. Users can prevent the
          acceptance of first-party cookies by adjusting their browser settings
        ...
        <p>
          ...
          website.
          <br />
          Google Analytics uses cookies which allow website use to be analysed
          (e.g. sites surfed by you, conversions, your interactions with our
          webpages, technical information of your browser, shortened
          IP-address). Pseudonymised user profiles are created for this purpose.
          We use Google Analytics only with activated IP anonymisation.
          Furthermore, we use the User-ID function. This function allows us to
          assign sessions and all activities during those sessions to a
          permanent User ID. It is therefore possible to analyse user behaviour
          across different devices.
          <br />
          You can prevent cookies from being stored by configuring the operating
          system settings on your browser or mobile device or within our cookie
          consent management tool accordingly. However, please bear in mind
          that, in this case, you may not be able to make full use all of the
          functions on our platform. You can also prevent the data produced by
          the cookie and information relating to your use of our website
        ...
        <p>
          ...
          network. Ad-vertising is inserted with the aid of cookies.
          <br />
          If you do not wish to receive interest-related advertising, you can
          deactivate the use of cookies for these purpos-es at
          https://adssettings.google.com/authenticated. Both services are
          subject to the Google Privacy Policy availa-ble for download at
          https://policies.google.com/privacy?hl=en-US. Google Marketing
          Platform
          <br />
          Google Marketing Platform enables its users to place ads on their
          websites. Advertisers can determine how often, when, and for how long
          ads are displayed in a browser, and use cookies to facilitate
          behavioural targeting by indi-cating which areas of a website you are
          browsing. A pseudonymised identification number is assigned to your
          browser in order to check which advertisements are displayed in your
          browser and which have been accessed. The cookies do not contain any
          personal data. You can deactivate the use of cookies by Google for
        ...
        <p>
          ...
          websites. When you visit websites with one of these integrated pixels,
          non-personal data is automatically transmitted to Facebook for
          analysing and marketing purposes, which is assigned a user ID by
          Facebook. As soon as you register with Facebook, Facebook assigns the
          transmitted data to your Facebook profile and assigns you to certain
          groups based on your surfing behaviour (so-called custom audiences).
          <br />
          ...
          as well as your settings options for protecting your privacy, please
          refer to the Facebook Pri-vacy Policy which can be found at
          https://www.facebook.com/ads/website_custom_audiences/ and
          https://www.facebook.com/privacy/explanation. If you wish to object to
          the use of the user-defined website from Facebook, you can do this at
